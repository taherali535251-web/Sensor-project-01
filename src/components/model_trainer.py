...
class ModelTrainer:
    ...
    def get_best_model(self,
        ...
        try:
            ...
            #to get best models from directory
    ...
    def initiate_model_trainer(self, train_array,test_array):
        try:
            ...
            logging.info(f"Extracting models config file path")
            ...
            # to get best model name fro dict
            ...
            if best_model_score < 0.5:
                raise Exception("no best model found with accuracy greater then the theshold 0.6")
